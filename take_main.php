...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="client_member_temp.php">登入</a><i class="fa fa-angle-double-right"></i><span>接案者</span> 
    ...
    <div align="center">
        ...
        <a href="case_list.php"><button type="submit" class="form-control-submit-button">查看po文</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="take_logout.php"><button type="submit" class="form-control-submit-button">登出</button></a>


        <div><br>您好, 接案者: <a href="taker_user_center.php"><?php echo $t_id?></a>
        </div><br>
    </div>
    <!-- Breadcrumbs -->
    <div class="ex-basic-1">
