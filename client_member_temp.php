...
<h2 align="center">歡迎來到屋幫兔，請輸入案主帳號密碼</h2><br>

    <form action="client_checkmem.php" method="POST" name="form1">
    <table align="center" width="325" >
        <tr>
            <th>
            輸入帳號拉:<input type="text" name="c_id" class="form-control-input" id="lname" >
        ...
        <tr>
            <th>
            輸入密碼拉:<input type="text" name="c_pwd"class="form-control-input" id="lname" >
            </th>
        </tr>
    ...
    <script type="text/javascript">
        function check_data(){
                if(document.form1.c_id.value.length==0){
                    alert("帳號欄位空白啦");
                }
                else if(document.form1.c_pwd.value.length==0){
                    alert("齁~密碼填一下");
                }
                else{
                    form1.submit();  
