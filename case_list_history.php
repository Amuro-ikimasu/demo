...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="client_member_temp.php">登入</a><i class="fa fa-angle-double-right"></i><a href="client_main.php">案主</a><i class="fa fa-angle-double-right"></i><a href="c_post.php">填寫任務</a><i class="fa fa-angle-double-right"></i><span>記錄</span>
    ...
    <p align="center"><img src="images/forum.png"></p>
  <?php
  ...
  //執行SQL查詢
  $sql = "SELECT * FROM `post` WHERE `c_id` ORDER BY `p_id` DESC";
  ...
  while ($row = mysqli_fetch_assoc($result) and $j <= $records_per_page) {
      echo "<tr>";
      echo "<td width='120' align='center'><img src='images/" . mt_rand(0, 9) . ".gif'></td>";
      echo "<td bgcolor='" . $bg[$j - 1] . "'>&nbsp;&nbsp;名稱：" . $row["p_name"] . "<br>";
      echo "&nbsp;&nbsp;種類：" . $row["p_type"] . "<br>";
      echo "&nbsp;&nbsp;時間：" . $row["p_time"] . "<br>";
      echo "&nbsp;&nbsp;價錢：" . $row["p_price"] . "<br><br>";
      echo "&nbsp;&nbsp;<a href='client_show_detail.php?p_id=";
      echo $row["p_id"] . "'>查看狀態</a></td></tr>";
      $j++;
  }
  echo "</table><br>";
  ...
  if ($page > 1)
    echo "<a href='case_list_history.php?page=" . ($page - 1) . "'>上一頁</a> ";

  for ($i = 1; $i <= $total_pages; $i++) {
    if ($i == $page)
      echo "$i ";
    else
      echo "<a href='case_list_history.php?page=$i'>$i</a> ";
  }

  if ($page < $total_pages)
    echo "<a href='case_list_history.php?page=" . ($page + 1) . "'>下一頁</a> ";

  echo "</p><br><br>";
  echo "<p align='center'><a href='case_list_all.php'>查看全部任務</a></p>";
