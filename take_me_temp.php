...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><span>登入</span>
    ...
    <h2 align="center">歡迎來到屋幫兔，請輸入接案者帳號密碼。</h2><br>
    
    <form action="take_check.php" method="POST" name="form_take">
    <table align="center" width="325">
        <tr>
            <th>
            輸入帳號拉:<input type="text" name="t_id" class="form-control-input" id="lname">
            </th>
        </tr>
        ...
        <tr>
            <th>
            輸入密碼拉:<input type="text" name="t_pwd" class="form-control-input" id="lname">
            </th>
        </tr>
    ...
    <script type="text/javascript">
        function check_data(){
                if(document.form_take.t_id.value.length==0){
                    alert("帳號欄位空白啦");
                }
                else if(document.form_take.t_pwd.value.length==0){
                    alert("齁~密碼填一下");
                }
                else{
                    form_take.submit();  
