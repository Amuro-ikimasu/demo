<?php
    ...
    if(mysqli_num_rows($result) !=0){
        ...
        mysqli_free_result($result);
        $sql =" INSERT INTO client(c_id,c_name,c_pwd,c_phone) VALUES ('$c_id','$c_name','$c_pwd','$c_phone')";
        $result = execute_sql($link,"ubuntu",$sql);
    }
    mysqli_close($link);
?>
...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="join.html">註冊</a><i class="fa fa-angle-double-right"></i><a href="client_join_member.php">案主</a><i class="fa fa-angle-double-right"></i><span>成功</span>
    ...
    <p align="center"><br>
        帳號:<font color="#FF4D00"><?php echo $c_id ?></font><br>
        姓名:<font color="#FF4D00"><?php echo $c_name ?></font><br>
        密碼:<font color="#FF4D00"><?php echo $c_pwd ?></font><br>
        電話:<font color="#FF4D00"><?php echo $c_phone ?></font><br><br>
        <h3 align="center">請前往<a href="client_member_temp.php">登入網站</a></h2>
    </p>
