...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="join.html">註冊</a><i class="fa fa-angle-double-right"></i><span>接案者</span>
    ...
    <form action="take_addmem.php" name="form_takejoin" method="POST"> 
        <h2 align="center">接案者註冊</h2><br>
        <table width="380" align="center">
            <tr>
                <th>使用者帳號:</th>
                <th><input type="text" name="t_id"></th>
            </tr>
            <tr>
                <th>使用者姓名:</th>
                <th><input type="text" name="t_name"></th>
            </tr>
            <tr>
                <th>使用者密碼:</th>
                <th><input type="text" name="t_pwd"></th>
            </tr>
            <tr>
                <th>連絡電話:</th>
                <th><input type="text" name="t_phone"></th>
            </tr>
            ...
            <tr>
                <th><center><input type="button" value="確定送出" onClick="check_data()"></center></th>
                <th><center><input type="reset" value="重新填寫"></center></th>
            </tr>
        </table>
    </form>
    ...
    <script>
        function check_data(){
            if(document.form_takejoin.t_id.value.length ==0){
                alert ("帳號填一下")
                return false;
            }
            if(document.form_takejoin.t_name.value.length ==0){
                alert ("姓名填一下")
                return false;
            }
            if(document.form_takejoin.t_pwd.value.length ==0){
                alert ("密碼沒填阿")
                return false;
            }
            if(document.form_takejoin.t_phone.value.length ==0){
                alert ("電話啦")
                return false;
            }
            form_takejoin.submit();
        }
    </script>
</body>
</html>