...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="client_member_temp.php">登入</a><i class="fa fa-angle-double-right"></i><span>案主</span>
    ...
    <div align="center">
    <h2>案主</h2><br>
        <a href="c_post.php"><button type="submit" class="form-control-submit-button">我要派任務</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="client_logout.php"><button type="submit" class="form-control-submit-button">登出</button></a>
    </div><br>
  ...
  <?php
        ...
        if (isset($c_id)) {
            echo "<p align='center'>您好, 案主: <a href='client_user_center.php'>" . $c_id . "</a></p>";
            echo "<h5 align='center'><a href='case_list_history.php' align='center'>點此</a>查詢訂單紀錄</h5>";
        } else {
            echo "未登入";
        }
    ?>
