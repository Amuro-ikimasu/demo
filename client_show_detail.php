...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <!-- 新增 --> 
                <li class="nav-item dropdown">
                    <a class="nav-link page-scroll" href="#service" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">服務項目</a>
                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="index.html">首頁</a><i class="fa fa-angle-double-right"></i><a href="client_main.php"><span>登入</span></a><i class="fa fa-angle-double-right"></i><a href="c_post.php"><span>表單</span></a><i class="fa fa-angle-double-right"></i><a href="case_list_history.php"><span>任務列表</span></a><i class="fa fa-angle-double-right"></i><span>查看詳情</span>
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    // echo "<form name = 'form_take' method='POST'" . $row["p_id"] . "&p_name=" . urlencode($row["p_name"]) . "&p_price=" . $row["p_price"] . "' >";

    $quant = $row["p_quant"];


    if ($quant == 1) {
      echo "<br><h2 align='center'>" . "任務還在"."</h2><br><br>";
    } else {

      echo "<div>" . "任務已有人接囉" . "</div>";
      echo "<div>" . "<a href='message_board.php?o_id='>".$row["o_id"]."前往留言板"."</a>";
    }
  ...
  <table align="center">
    <tr>
      <td><a href="client_main.php">回首頁</a></td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
